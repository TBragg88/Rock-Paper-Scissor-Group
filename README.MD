...
- **Difficulty Settings:**  
    ...
    - *Easy:* The AI intentionally makes losing moves, ideal for learning the ropes.
    - *Medium:* The AI selects moves at random, offering a fair and unpredictable challenge.
    - *Hard:* The AI analyzes your patterns and tries to win, providing a true test of strategy.
